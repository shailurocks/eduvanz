...
@section('content')
        <div class="container">
            <center><h5>Add Participants</h5></center><hr>
            ...
            <form name="getDetails" id="getDetails" action="{{ url('/') }}/add_participant"  class="form-inline" method="POST">
                <div class="row">
                    ...
                    <div class="form-group search-filter">
                        ...
                        <input type="text" class="datepicker form-control" name="dob" id="dob" autocomplete="off" value=""  required/>   
                    </div>
                </div>
                <div class="row">
                    <div class="form-group search-filter">
                        <label class="form-label" >Locality : &nbsp;</label>
                        <input type="text" class="form-control" name="locality" id="locality" autocomplete="off" value="" required/>
                    </div>
                    <div class="form-group search-filter">
                        <label class="form-label" >Number Of Guest : &nbsp;</label>
                        <input type="text" class="form-control" name="no_of_guest" id="no_of_guest" autocomplete="off" value="" required/>  
                    </div>
                 </div>   
                <div class="row">
                    <div class="form-group search-filter">
                    ...
                    <div class="form-group search-filter">
                        ...
                        <textarea class="form-control" rows="5" cols="50" id="address" name="address" required maxlength="50"></textarea>
                    </div>
                    <div class="form-group search-filter">
